  ...
  <body class="bg-gray-200 p-10">
    ...
    <div class="max-w-screen-xl mx-auto bg-white p-10 rounded-lg shadow-lg">
      ...
      <section class="mb-10">
        ...
        <div class="grid grid-cols-2 gap-6">
          ...
          <select class="border p-3 rounded w-full col-span-2">
      ...
      <div class="text-center mt-12">
        <button
          type="button"
          class="bg-black text-white px-10 py-3 rounded text-lg font-medium border-4 border-black hover:bg-gray-800"
        >
          Lanjutkan
        </button>
      </div>
    ...
    <script>
      ...
      function addPhoto() {
        ...
        newSlot.innerHTML = `
          <input type="file" accept="image/*" onchange="previewImage(this)" class="absolute w-full h-full opacity-0 cursor-pointer z-20"/>
